-- ================================================
-- Safe Update Script for Attendance Records Table
-- This script only creates what doesn't exist
-- ================================================
...
-- View 1: Attendance summary by class and date
...
-- View 2: Detailed attendance records with class info
...
DO $$ 
BEGIN
    RAISE NOTICE 'Attendance records table verified/updated successfully!';
END $$;
