...
CREATE UNIQUE INDEX idx_class_statistics_class_section ON class_statistics(class_section);
...
BEGIN
  ...
  -- Requires unique index on class_section
...
COMMENT ON COLUMN class_statistics.class_section IS 'Class section identifier matching students.classSection';
